...
public class Factory {
    ...
    public ItemDetail createItemDetail() {
        ...
        while(true) {
        String setItemName = getStringInput("Enter item details (Hit enter to quit)? ");
        if(setItemName.trim().isEmpty()) break;
        String setItemDescription = getStringInput("Category: ");
